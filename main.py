...
# Simple face detector only (no heavy mesh for now)
...
cv2.resizeWindow("Face Detection Test", 1280, 720)

print("Face Detection Test")
print("If you see green rectangles around faces → detection is working")
